    ...
    <c:forEach var="c" items="${map.pList}">
        <div class="col-lg-3 col-sm-6">
            ...
            <div class="accomodation_item text-center">
                ...
                <h3 class="sec_h4">${c.name}</h3>
                <h3>${c.price}</h3>
            </div>
            <div class="row">
                <div class="col-6">
                    <form action="/cart/save" method="POST">
                        <input type="hidden" class="form-control" value="${c.id}" name="pid" id="name" aria-describedby="emailHelp">
                        <input type="hidden" class="form-control" value="${c.name}" name="pName" id="name" aria-describedby="emailHelp">
                        <input type="hidden" class="form-control" value="${c.code}" name="pCode" id="code" aria-describedby="emailHelp">
                        <input type="hidden" class="form-control" value="${c.sp}" name="sp" id="photo" aria-describedby="emailHelp" >
                        <input type="hidden" class="form-control" value="${c.des}" name="des" id="photo" aria-describedby="emailHelp" >
                        <input type="hidden" class="form-control" value="${c.price}" name="pPrice" id="price" aria-describedby="emailHelp">
                        <input type="hidden" class="form-control" value="${c.photo}" name="photo" id="photo" aria-describedby="emailHelp">
                        <input type="hidden" class="form-control" value="${c.discount}" name="discount" id="photo" aria-describedby="emailHelp">

                        <a href="#"><input type="submit" class="btn-primary" value="Add to Cart" ></a>
                        <!--<a href="/production/view2"><input type="button" class="btn-info" value="Product Details" ></a>-->
                        <!--                /production/view2-->
...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-8"><h1>Ecommerce Online Shop</h1></div>
    </div>
</div>
<div class="row mb_30">
