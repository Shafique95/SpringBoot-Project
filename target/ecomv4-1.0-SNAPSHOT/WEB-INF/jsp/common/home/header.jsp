        ...
        <div class="nav">
            <div class="container-fluid">
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    <a href="#" class="navbar-brand">Menue</a>
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="http://localhost:8080/" class="nav-item nav-link active">Back To Home</a>
                            ...
                            <a href="/checkout/create" class="nav-item nav-link active">Cart Check</a>
                            <a href="/myAccount" class="nav-item nav-link active">My Account</a>
                            <a href="/merchant" class="nav-item nav-link active">Other Business</a>
                            <a href="/wishlist/view" class="nav-item nav-link active">Wishlist</a>
                             <a href="/contact/create" class="nav-item nav-link active">Feedback</a>
<!--                            <a href="/contact/create" class="nav-item nav-link active">Contact</a>-->
                    ...
                    <div style=" margin-right: 0px">
                            ...
                            <a href="" data-toggle="modal" data-target="#modalLoginForm" class="dropdown-item">Admin</a>
                    </div>
                </nav>
            </div>
        </div>
