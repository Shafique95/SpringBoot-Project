                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-widget">
                            ...
                            <div class="contact-info">
                                ...
                                <p><i class="fa fa-envelope"></i>ecommerce@gmail.com</p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 copyright">
                        <p>Copyright &copy; <a href="www.ecommerc.com">Ecommerce LTD</a>. All Rights Reserved</p>
                    </div>

                    <div class="col-md-6 template-by">
                        <p>Design By <a href="https://htmlcodex.com">Shafiqul Islam</a></p>
                    </div>
                </div>
            </div>
        </div>-->
