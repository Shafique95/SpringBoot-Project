                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="/wishlist" class="nav-item nav-link active">Wishlist</a>
                            <a href="/contact/create" class="nav-item nav-link active">Contact Us</a>
                    ...
                    <div style=" margin-right: 0px">
                            ...
                            <a href="" data-toggle="modal" data-target="#modalLoginForm" class="dropdown-item">Merchant Admin</a>
                    </div>
                </nav>
            </div>
        </div>
