                ...
                <form method="post" action="/orders/save">
                    <div class="cart-page-inner">
                        <div class="table-responsive">
                            <table class="table table-bordered bg-secondary" id="basket">
...
<!--                                <input type="text" placeholder="Coupon Code">
                        ...
                        <div class="col-md-12">
                            <div class="cart-summary">
                                <div class="cart-content bg-secondary">
                                ...
                                <div class="cart-btn">
                                    <button class="btn btn-outline-secondary"><a href="/production/view">Update Cart</a></button>
                                    <button class="btn btn-outline-secondary"><a href="/checkout/create">Checkout</a></button>
...
<script>     function change(el) {
        ...
        calcTotal();
        //After working         var lblTotal = $("#lblTotal").text();
        $("#sub").text(lblTotal);
