...
<jsp:include page="/WEB-INF/jsp/merchantCommon/header.jsp"/>
...
<div class="chart-layer-2">
	...
	<div class="col-md-6 chart-layer2-right">
	        ...
	        <div class='bar_group'>
				...
				<script src="resources/admin/js/bars.js"></script>
...
<!--COPY rights end here-->
 <jsp:include page="/WEB-INF/jsp/merchantCommon/footer.jsp" />