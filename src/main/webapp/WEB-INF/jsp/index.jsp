    ...
    <div class="modal-content">
      ...
      <div class="modal-body mx-3">
        <div class="md-form mb-5">
          ...
          <input type="email" id="defaultForm-email" value="admin@gmail.com" class="form-control validate">
...
<!-- Main Slider Start -->
    <div class="container-fluid">
        <h1 style=" text-align: center"> Best Online Selling Platform</h1>
        <div class="row">
            <%--extra--%>
            ...
            <div class="col-2">
                ...
                <nav class="navbar bg-secondary">
                    ...
                    <ul class="navbar-nav text-dark ">
                        <li class="nav-item">
                            <a class="nav-link text-light " href="http://localhost:8080/store"><i class="fa fa-home"></i>Home</a>
                        </li>
                ...
                <div class="header-slider normal-slider">
                    <div class="header-slider-item">
                        ...
                        <div class="header-slider-caption">
                            ...
                            <a class="btn" href="http://localhost:8080/store"><i class="fa fa-shopping-cart"></i>Shop Now</a>
                        </div>
                    </div>
                    <div class="header-slider-item">
            ...
            <div class="col-3">
                <div class="header-slider normal-slider">
                    <div class="header-slider-item">
                        <img src="/resources/home/img/slider-7.jpg" alt="Slider Image" />
                        <div class="header-slider-caption">
                            <p>Best selling product</p>
                            <a class="btn" href="http://localhost:8080/store"><i class="fa fa-shopping-cart"></i>Shop Now</a>
                        </div>
                    ...
                    <div class="header-slider-item">
                        <img src="/resources/home/img/slider-8.jpg" alt="Slider Image" />
                        <div class="header-slider-caption">
                            <p>Available product</p>
                            <a class="btn" href="http://localhost:8080/store"><i class="fa fa-shopping-cart"></i>Shop Now</a>
                        </div>
                    ...
                    <div class="header-slider-item">
                        <img src="/resources/home/img/slider-9.jpg" alt="Slider Image" />
                        <div class="header-slider-caption">
                            <p>This product is not available</p>
                            <a class="btn" href="http://localhost:8080/store"><i class="fa fa-shopping-cart"></i>Shop Now</a>
                        </div>
                ...
                <p>Top Selling</p>
                 <div class="header-slider normal-slider">
                    <div class="header-slider-item">
                        <img src="/resources/home/img/slider-10.jpg" alt="Slider Image" />
                        <div class="header-slider-caption">
                            <p>Best selling product</p>
                            <a class="btn" href="http://localhost:8080/store"><i class="fa fa-shopping-cart"></i>Shop Now</a>
                        </div>
                    ...
                    <div class="header-slider-item">
                        <img src="/resources/home/img/slider-11.jpg" alt="Slider Image" />
                        <div class="header-slider-caption">
                            <p>Available product</p>
                            <a class="btn" href="http://localhost:8080/store"><i class="fa fa-shopping-cart"></i>Shop Now</a>
                        </div>
                    ...
                    <div class="header-slider-item">
                        <img src="/resources/home/img/slider-12.jpg" alt="Slider Image" />
                        <div class="header-slider-caption">
                            <p>This product is not available</p>
                            <a class="btn" href="http://localhost:8080/store"><i class="fa fa-shopping-cart"></i>Shop Now</a>
                        </div>
            ...
            <div class="col-3">
                <div class="header-img">
                    <div class="img-item">
                        <img src="/resources/home/img/category-1.jpg" />
                        <a class="img-text" href="">
                            <p>Click here to see available products</p>
                        </a>
                    </div>
                    <div class="img-item">
                        <img src="/resources/home/img/category-2.jpg" />
                        <a class="img-text" href="">
                            <p>Click here to see available products</p>
                        </a>
                    </div>
