            ...
            <div class="col-lg-4 sidebar">
                <div class="sidebar-widget category">
                    ...
                    <nav class="navbar bg-light">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="#"><i class="fa fa-female"> </i>Category1</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#"><i class="fa fa-child"> </i>Category1</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#"><i class="fa fa-tshirt"></i>Category1</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#"><i class="fa fa-mobile-alt"></i>Category1</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#"><i class="fa fa-microchip"></i>Category</a>
                            </li>
                        </ul>
                    </nav>
                </div>
                ...
                <div class="sidebar-widget brands">
                    ...
                    <ul>
                      <li><a href="#">Our Brand1 </a><span>(45)</span></li>
                        <li><a href="#">Our Brand1</a><span>(34)</span></li>
                        <li><a href="#">Our Brand1</a><span>(67)</span></li>
                        <li><a href="#">Our Brand1</a><span>(74)</span></li>
                        <li><a href="#">Our Brand1</a><span>(89)</span></li>
                        <li><a href="#">Our Brand1</a><span>(28)</span></li>
                    </ul>
                </div>
